...
//        if (RemexGlobalTransactionalInterceptor.defaultGlobalTransactionTimeout <= 0) {
...
//                defaultGlobalTransactionTimeout = DEFAULT_GLOBAL_TRANSACTION_TIMEOUT;
//            }
//            RemexGlobalTransactionalInterceptor.defaultGlobalTransactionTimeout = defaultGlobalTransactionTimeout;
//        }
//    }
//
//    //endregion
...
//            Transactional transactional = getAnnotation(method, targetClass, Transactional.class);
...
//    }
//    
//    Object remexHandleGlobalTransaction(final MethodInvocation methodInvocation,
...
//                    public TransactionInfo getTransactionInfo() {
//                        // reset the value of timeout
//                        int timeout = DefaultValues.DEFAULT_GLOBAL_TRANSACTION_TIMEOUT;
//                        if (timeout <= 0 || timeout == DEFAULT_GLOBAL_TRANSACTION_TIMEOUT) {
//                            timeout = defaultGlobalTransactionTimeout;
//                        }
//
...
//                        transactionInfo.setLockRetryTimes(-1);
//                        Set<RollbackRule> rollbackRules = new LinkedHashSet<>();
//                        for (Class<?> rbRule : transactional.rollbackFor()) {
//                            rollbackRules.add(new RollbackRule(rbRule));
//                        }
//                        for (String rbRule : transactional.rollbackForClassName()) {
//                            rollbackRules.add(new RollbackRule(rbRule));
//                        }
//                        for (Class<?> rbRule : transactional.noRollbackFor()) {
//                            rollbackRules.add(new NoRollbackRule(rbRule));
//                        }
//                        for (String rbRule : transactional.noRollbackForClassName()) {
//                            rollbackRules.add(new NoRollbackRule(rbRule));
//                        }
//                        transactionInfo.setRollbackRules(rollbackRules);
//                        return transactionInfo;
